...
class Strax:
    ...
    def in_background(self, run_id, targets, sources=tuple(), save=tuple()):
        ...
        return BackgroundThreadProcessor(components, self.executor)
