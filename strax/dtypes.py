...
def peak_dtype(n_channels=100, n_sum_wv_samples=200, n_widths=11):
    ...
    return interval_dtype + [
        ...
        (('Waveform data from the top array in PE/sample (not PE/ns!)',
          'data_top'), np.float32, n_sum_wv_samples),
        (('Waveform data from the bottom array in PE/sample (not PE/ns!)',
          'data_bottom'), np.float32, n_sum_wv_samples),
